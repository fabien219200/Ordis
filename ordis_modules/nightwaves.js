    ...
    axios.get("https://api.warframestat.us/pc/nightwave")
        .then((response) => {
            ...
            let embed = new Discord.RichEmbed()
                ...
                .addField("Actes journaliers :" , ":white_small_square:(1j)**" + response.data.activeChallenges[0].title + " (" + response.data.activeChallenges[0].reputation + ")** :\n" + response.data.activeChallenges[0].desc + "\n:white_small_square:(2j)**" + response.data.activeChallenges[1].title + " (" + response.data.activeChallenges[1].reputation + ")** :\n" + response.data.activeChallenges[1].desc + "\n:white_small_square:(3j restant)**" + response.data.activeChallenges[2].title + " (" + response.data.activeChallenges[2].reputation + ")** :\n" + response.data.activeChallenges[2].desc)
                .addBlankField()
